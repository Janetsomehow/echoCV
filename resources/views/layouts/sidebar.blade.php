    ...
    <main class="sidebar">
      ...
      <a href="/index" class="sidebar-li home"><img src="{{ asset('css/icons/homeIcon.png') }}" />HOME</a>
      ...
      <a href="/contacts" class="sidebar-li contact"><img src="{{ asset('css/icons/contact.png') }}" />CONTACTS</a>
