...
<div class="container-fluid">
  <div class="header">
<div class="d-flex">
  <div class="p-2"><h4>Portfolio Company</h4></div>
  <div class="ml-auto p-2"><a href="#" class="btn btn-primary text-white  mb-1">&plus; Add Company </a></div>
</div>
</div>
...
<form class="form-inline form-group">
  ...
  <select  class="col-xs-2" style= "width:10%; position:absolute; left:27rem; height:2rem; top:10; bottom:35.8rem;">
...
<p>Analyst:Bimpe</p>  
  ...
  <div><div><img src="{{ asset('css/icons/ibm.png') }}" class="img-fluid"></div>
  <h6>IBM</h6><br>
<p>Lead:Maria</p>  
<p>Analyst:Bimpe</p>  
...
<p>Analyst:Bimpe</p>  
  ...
  <div><div><img src="{{ asset('css/icons/pizza.png') }}" class="img-fluid"></div>
  <h6>Pizza hut</h6><br>
<p>Lead:Maria</p>  
<p>Analyst:Bimpe</p>  

</div>
  <div><div><img src="{{ asset('css/icons/life.png') }}" class="img-fluid"></div>
  <h6>Life Bank </h6><br>
<p>Lead:Maria</p>  
<p>Analyst:Bimpe</p>  

</div>
  <div><div><img src="{{ asset('css/icons/electric.png') }}" class="img-fluid"></div>
  <h6>Electric </h6><br>
<p>Lead:Maria</p>  
<p>Analyst:Bimpe</p>  
</div>
  <div><div><img src="{{ asset('css/icons/master.png') }}" class="img-fluid"></div>
  <h6>Master card </h6><br>
<p>Lead:Maria</p>  
<p>Analyst:Bimpe</p>  
</div>
</div>
